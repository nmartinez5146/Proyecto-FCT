...
class AppTests {
	...
	void consultAllRecordsSuccess() throws UserException, WrongUserException {
		List<PracticeRecord> records = userService.consultAllRecords(testUser, LocalDate.of(2024, 3, 15),
				LocalDate.now(), "All");
	...
	void consultAllRecordsUserWithoutStudentId() {
		...
		assertThrows(UserException.class, () -> {
			userService.consultAllRecords(userWithoutStudent, LocalDate.of(2024, 3, 15), LocalDate.now(), null);
		});
	}
	...
	void createRecordNullRecord() {
		assertThrows(IncorrectDataException.class, () -> userService.createRecord(null));
	}
	...
	void createRecordNoStudentOrDate() {
		...
		assertThrows(IncorrectDataException.class, () -> userService.createRecord(recordWithoutStudent));
		...
		assertThrows(IncorrectDataException.class, () -> userService.createRecord(recordWithoutDate));
	}
